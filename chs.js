...
var cnItems = {
    ...
    'Only your star types increases the compressor\'s effect with squared effect. Space Energy no longer boost Space Foam. Disable Normal Energy. Cap Time Compressors to': '只有恒星数量可以加成压缩器的效果，且效果为原来的平方。空间能量不再加成空间泡沫。正常能量暂时失效。时间压缩器个数被限制为',
